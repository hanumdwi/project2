...
<div class="bs-example widget-shadow" data-example-id="bordered-table">
		<table class="table table-bordered">
            ...
            <td><a href="productedit{{$p -> product_id}}">
                                                    ...
                                                    <path fill-rule="evenodd" d="M14.146 8.354l-2.5-2.5.708-.708 2.5 2.5-.708.708zM5 12v.5a.5.5 0 00.5.5H6v.5a.5.5 0 00.5.5H7v.5a.5.5 0 00.5.5H8v-1.5a.5.5 0 00-.5-.5H7v-.5a.5.5 0 00-.5-.5H5z" clip-rule="evenodd"></path>
                                                        ...
                                                        <button type="button" class="label label-danger" data-toggle="modal" data-target="#exampleModal{{$p -> product_id}}">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="productdestroy{{$p -> product_id}}" ><button type="button" class="btn btn-primary">Delete</button></a>
                                                            </div>
                                                            </div>
                                                        </div>
                                                        </div>                        
        ...
        <!-- END PAGE CONTAINER -->    
   <script>
   swal("Welcome to Product!", "You clicked the button!", "success");
   </script>
@endsection