...
<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
            ...
            <tbody>
                ...
                <td>{{ $c -> category_name }}</td>
                   ...
                   <path fill-rule="evenodd" d="M13.293 3.293a1 1 0 011.414 0l2 2a1 1 0 010 1.414l-9 9a1 1 0 01-.39.242l-3 1a1 1 0 01-1.266-1.265l1-3a1 1 0 01.242-.391l9-9zM14 4l2 2-9 9-3 1 1-3 9-9z" clip-rule="evenodd"></path>
                    ...
                    @else
                    <button type="button" class="label label-warning edit" data-toggle="modal" data-target="#exampleModal1">
                    <svg class="bi bi-pencil" width="3em" height="2em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M13.293 3.293a1 1 0 011.414 0l2 2a1 1 0 010 1.414l-9 9a1 1 0 01-.39.242l-3 1a1 1 0 01-1.266-1.265l1-3a1 1 0 01.242-.391l9-9zM14 4l2 2-9 9-3 1 1-3 9-9z" clip-rule="evenodd"></path>
                    <path fill-rule="evenodd" d="M14.146 8.354l-2.5-2.5.708-.708 2.5 2.5-.708.708zM5 12v.5a.5.5 0 00.5.5H6v.5a.5.5 0 00.5.5H7v.5a.5.5 0 00.5.5H8v-1.5a.5.5 0 00-.5-.5H7v-.5a.5.5 0 00-.5-.5H5z" clip-rule="evenodd"></path>
                    </svg>Edit </button>
                    ...
                    @endif
                    <button type="button" class="label label-danger" data-toggle="modal" data-target="#exampleModal{{$c -> category_id}}">
                    ...
                    <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <a href="categoriesdestroy{{$c -> category_id}}" ><button  id="modal{{$c -> category_id}}" onclick="tampil(id)" type="button" class="btn btn-primary">Delete</button></a>
                    </div>
                    </div>
                    </div>
                    </div>    
   ...
   <script>
            ...
            swal("Welcome to Categories!", "You clicked the button!", "success");
            // swal("Welcome to Data Category!");
            function create(id){
